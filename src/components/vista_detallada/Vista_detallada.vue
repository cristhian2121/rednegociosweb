            ...
            <div class="masonry">
                ...
                <div class="masonry__brick">
                    <div class="item-folio">
                        ...
                        <div class="item-folio__text">
                            <h3 class="item-folio__title">Fuji</h3>
...
export default {
  ...
  methods: {
    ...
    traer_empresas: function() {
      axios
        .get(`http://127.0.0.1:8000/api/detalle/?nombre=${this.nombre_empresa}`)
        .then(respuesta => {
    ...
    traer_servicios: async function() {
      axios.get("http://127.0.0.1:8000/api/servicio/").then(respuesta => {
