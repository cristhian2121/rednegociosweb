  ...
  <div>       
        ...
        <div class="row">
            ...
            <div class="form-CMXD row col-md-6">
                ...
                <div class="input-effect js-input">
                    <label>Ciudad</label>
                    <select class="CMXD-material-input" v-model="empresaModel.id_ciudad" clearable placeholder="Seleccionar">
                        <option v-for="ciudad in ciudades" :key="ciudad.id_ciudad" :label="ciudad.ciudad" :value="ciudad.id_ciudad"></option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-CMXD row col-md-6">
                ...
                <div class="input-effect js-input">
                    <input class="CMXD-material-input" id="dir_emp" name="direccion" type="text" placeholder="Dirección" v-model="empresaModel.direccion">
                    <span class="focus-border"></span>
        ...
        <div class="row">
            ...
            <div class="form-CMXD row col-md-6">
                ...
                <div class="input-effect js-input">
                    ...
                    <select class="CMXD-material-input" v-model="empresaModel.id_tipo" clearable placeholder="Seleccionar sección">
                        <option v-for="tipo in tipos" :key="tipo.id_tipo" :label="tipo.nombre" :value="tipo.id_tipo"></option>
                    </select>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="form-CMXD row col-md-6">
                <el-upload action="http://68.183.124.242:8000/api/archivo/" multiple :limit="1" class="btn-services" :on-exceed="exceso_archivos">
